...
window.addEventListener('load', () => {
    ...
    const geometry_yellow = new THREE.BoxGeometry(1, 2.5, 0.25);
    ...
    wall_yellow.position.set(-0.75, 0, 0);
    scene.add(wall_yellow);

    const geometry_green = new THREE.BoxGeometry(1, 2, 0.5);
